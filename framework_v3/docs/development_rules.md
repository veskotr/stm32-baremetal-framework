# framework_v3 Development Rules

## Purpose

This document defines the rules for adding code, integrations, tooling, and boards to `framework_v3`.
...
`framework_v3` must always support an easy firmware workflow.
...
- `framework_v3/README.md`
- `framework_v3/docs/architecture.md`
- `framework_v3/docs/development_rules.md`
